export default function WavyFooter() {
  // Main container for the footer with relative positioning
  return (
    <div className="relative w-full h-[111px]">
      {/* First SVG wave shape */}
      <svg
      ...
      >
        <path
          ...
          fill="#20DF7F" // Color of the wave
          fillOpacity="0.09" // Transparency of the wave
        />
      </svg>

      {/* Second SVG wave shape */}
      <svg
      ...
      >
        <path
          ...
          fill="#E5E5E5" // Color of the wave
          fillOpacity="0.13" // Transparency of the wave
        />
      </svg>
    </div>
  );
